...
const int MOTOR_ENABLE = 9;    // Motor driver Enable pin (PWM control)
...
unsigned long motorStartTime;  // Timer for DC motor
bool motorRunning = true;      // Flag to track motor state
...
void setup() {
  ...
  Serial.println("System Initialized. DC Motor Running.");
}
